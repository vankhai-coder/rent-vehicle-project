import { fetchCustomerBookings } from "@/redux/features/owner/bookingSlice"
import { Loader } from "lucide-react"
import { useEffect } from "react"
import { useDispatch, useSelector } from "react-redux"

const ViewAllCustomerBooking = () => {

  // redux : 
  const dispatch = useDispatch()
  const { loading, bookings } = useSelector(state => state.owner_booking)
...
export default ViewAllCustomerBooking